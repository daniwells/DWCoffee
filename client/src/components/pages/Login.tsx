                ...
                <section className="w-full bg-customWhiteOpacityLow rounded-xl z-10">
                    ...
                    <form onSubmit={sendDatas} className="flex flex-col py-20 px-14 items-center justify-center gap-10">
                        ...
                        <section className="flex flex-col gap-10" >
                            <Input styleProp="registerAndLogin" data_group="PersonalDatas" name="email" text="Name or Email" permitionValues="all" onChange={setValuesInputs} />
                            <Input styleProp="registerAndLogin" data_group="PersonalDatas" name="password" text="Password" permitionValues="all" type="password" onChange={setValuesInputs} />
                        </section>
                        <section className="flex flex-col items-center justify-center gap-10 ">
                            <section className="flex justify-between w-14/12 " >
                                <LinkButton styleProp="transparent" text="Don't have an account?" to="/login" />
