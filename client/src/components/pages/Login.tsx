                ...
                <section className="w-full bg-customWhiteOpacityLow rounded-xl z-10">
                    ...
                    <form className="flex flex-col py-20 px-14 items-center justify-center gap-10">
                        ...
                        <section className="flex flex-col gap-10" >
                            <InputRegister styleProp="registerAndLogin" data_group="PersonalDatas" name="nameOrEmail" text="Name or Email" type="all"/>
                            <InputRegister styleProp="registerAndLogin" data_group="PersonalDatas" name="password" text="Password" type="all"/>
                        </section>
