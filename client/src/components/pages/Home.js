import YellowLinkButton from '../items/LinkButton'
...
function Home(){
    return (  
        <main className={'flex flex-col space-y-24 items-center mb-24'}>
            <ParallaxImage image='home_image'/>
            <Article className={'flex flex-col w-full justify-center items-center px-12 min-w-36 space-y-10'}>
                ...
                <YellowLinkButton text='READ MORE' to="/about" />
            </Article>
            <section className={'bg-customBlack py-2 w-full'}>
                <ParallaxImage image='home_image2'></ParallaxImage>
            </section>
            <Article className={'flex flex-col w-full justify-center items-center px-12 min-w-36 space-y-10 '}>
                ...
                <YellowLinkButton text='SEND CURRICULUM' to="/about"/>
            </Article>
            <ParallaxImage image='home_image3'/>
            <Article>
                <SubTittle text="INFO" textStyle='text-3xl font-archivoBlack' lineStyle='bg-black w-20 h-0.5 mt-3'/>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3577.950611805961!2d-48.86249012368021!3d-26.2632662663838!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94deafc576601a05%3A0x5e15c8877b6dbb3a!2sSENAI%20Joinville%20Norte%20II!5e0!3m2!1spt-BR!2sbr!4v1703470302040!5m2!1spt-BR!2sbr" 
                ...
                <section className='flex flex-col justify-center w-full items-center group cursor-pointer'>
                    <Link className={'font-archivoBlack text-xl group-hover:text-customYellow transition-all duration-300 ease-in-out'}>RESTAURANTS</Link>
