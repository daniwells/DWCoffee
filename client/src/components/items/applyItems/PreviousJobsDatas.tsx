        ...
        <>
            { Object.entries(addOrDelete).map( ([key, value]) => (
                    <section key={key} className="space-y-5 my-10">
                        <InputApply styleProp="apply" data_group={key} name="company" text="Company" onChange={handleChange} value={jobs[key] ? jobs[key].company : ''} type="all"/>
                        <InputApply styleProp="apply" data_group={key} name="position" text="Position" onChange={handleChange} value={jobs[key] ? jobs[key].position : ''} type="text" />
                        ...
                        <InputApply styleProp="apply" data_group={key} name="country" text="Company country" onChange={handleChange} value={jobs[key] ? jobs[key].country : ''} type="all"/>
                        <InputApply styleProp="apply" data_group={key} name="state" text="Company state" onChange={handleChange} value={jobs[key] ? jobs[key].state : ''} type="all"/>
                        <InputApply styleProp="apply" data_group={key} name="city" text="Company city" onChange={handleChange} value={jobs[key] ? jobs[key].city : ''} type="all"/>
                        <InputApply styleProp="apply" data_group={key} name="street" text="Company street" onChange={handleChange} value={jobs[key] ? jobs[key].street : ''} type="all"/>
