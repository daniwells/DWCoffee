...
const PersonalDatas: React.FC<PersonalDatasProps> = ({sendDatasFather}) => {
  const [values, setValues] = useState<stringObject>({name:'',phone:'',date:'',cep:'',country:'',state:'',city:'',cpf:''})  
  ...
  return (
    <>
      <section className="my-10 space-y-5" >
        <InputApply minLength={1} maxLength={255} styleProp="apply" data_group="PersonalDatas" name="name" text="Full name" onChange={handleChange} value={values.name} permitionValues="text"/>
        <InputApply minLength={1} maxLength={15} styleProp="apply" data_group="PersonalDatas" name="cpf" text="CPF" mask="999.999.999-99" onChange={handleChange} value={values.cpf}/>
        <InputApply minLength={1} maxLength={16} styleProp="apply" data_group="PersonalDatas" name="phone" text="Phone" mask="(99) 99999-9999" onChange={handleChange} value={values.phone}/>
        <InputApply minLength={1} maxLength={11} styleProp="apply" data_group="PersonalDatas" name="date" text="Date of birth" mask="99/99/9999" onChange={handleChange} value={values.date}/>
        <InputApply minLength={1} maxLength={10} styleProp="apply" data_group="PersonalDatas" name="cep" text="CEP" mask="99999-999" onChange={handleChange} value={values.cep}/>
