  ...
  return (
    <>
      <section className="my-10 space-y-5" >
        <InputApply styleProp="apply" data_group="PersonalDatas" name="name" text="Full name" onChange={handleChange} value={values.name} permitionValues="text"/>
        ...
        <InputApply styleProp="apply" data_group="PersonalDatas" name="country" text="Country" onChange={handleChange} value={values.country} permitionValues="text"/>
        <InputApply styleProp="apply" data_group="PersonalDatas" name="state" text="State" onChange={handleChange} value={values.state} permitionValues="text"/>
        <InputApply styleProp="apply" data_group="PersonalDatas" name="city" text="City" onChange={handleChange} value={values.city} permitionValues="text"/>
        <LongTextInputApply 
          name="about" 
