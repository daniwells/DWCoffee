...
const LinkButton: React.FC<LinkButtonProps> = ({text, style, to}) => { 
    ...
    return <Link className={`flex justify-center text-sm p-3 rounded-2xl font-archivoBlack ${style}`} to={to}>{text}</Link>
}
